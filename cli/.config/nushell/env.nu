...
# $env.PATH = $"($env.HOME)/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin:($env.HOME)/.nix-profile/bin:($env.HOME)/.local/venv/bin:($env.HOME)/.local/bin:($env.HOME)/.krew/bin:($env.HOME)/.arkade/bin:($env.HOME)/.config/npm-global/bin:($env.HOME)/.deno/bin/:($env.HOME)/.cargo/bin:($env.PATH)"
#$env.PATH = $"($env.HOME)/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin:($env.HOME)/.nix-profile/bin:($env.HOME)/.local/venv/bin:($env.HOME)/.local/bin:($env.GOPATH)/bin:($env.HOME)/.krew/bin:($env.HOME)/.arkade/bin:($env.HOME)/.config/npm-global/bin:($env.HOME)/.deno/bin/:($env.HOME)/.cargo/bin:($env.PATH)"
