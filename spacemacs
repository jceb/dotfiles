...
(defun dotspacemacs/user-config ()
  ...
  ;; use C-n and C-p the same way as C-j and C-k
  (define-key global-map (kbd "C-n") 'company-select-next)
  (define-key global-map (kbd "C-p") 'company-select-previous)
