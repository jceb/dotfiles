...
export alias jbb = ^jj bc
export alias jbc = ^jj bc
export alias jbl = ^jj bl
export alias jbs = ^jj bs
export alias jbt = ^jj bt
export alias jc = ^jj c
export alias jci = ^jj ci
export alias jd = ^jj diff
export alias jde = ^jj desc
export alias jdm = ^jj diff-main
export alias je = ^jj e
export alias jee = ^jj ee
export alias jf = ^jj f
export alias jg = ^jj git
export alias jgf = ^jj gf
export alias jp = ^jj gp
export alias jgp = ^jj gp
export alias jgu = ^jj gu
export alias ju = ^jj gu
export alias jl = ^jj l
export alias jll = ^jj ll
export alias jla = ^jj la
export alias jlb = ^jj lb
export alias jlbt = ^jj lbt
export alias jlt = ^jj lt
export alias jlh = ^jj lh
export alias jls = ^jj js
export alias jn = ^jj new
export alias jr = ^jj r
export alias jrm = ^jj rm
export alias js = ^jj s
export alias jsi = ^jj si
export alias jsp = ^jj sp
export alias jspi = ^jj spi
export alias jsq = ^jj sq
export alias jss = ^jj sq
export alias jst = ^jj status
export alias jtg = ^jj tg
export alias jtug = ^jj tug
export alias jt = ^jj t
export def jjignore [
  --force (-f)
